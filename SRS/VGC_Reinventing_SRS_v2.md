...
| Participation ticket | Proposed by the **pioneer** as a marketplace item linked to the season — RG-blog-ticket pattern: members must hold it to enter the season's events. Revenue escrows until season settlement, then splits **VGC Admin / pioneer per the share the pioneer proposed and VGC Admin confirmed** (§11.13.4). |

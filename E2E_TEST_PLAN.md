...
| Error white-screen risk | No app-level React error boundary was found | Inject controlled component/data-shape failures and verify whether the entire app becomes unrecoverable |
